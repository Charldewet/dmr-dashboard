  ...
  return (
    <div className="dashboard-container">
      ...
      <Header
        ...
        allowedPharmacies={allowedPharmacies}
      ...
      {view === 'dashboard' && (
        <DashboardView
          dashboardMonthlyAgg={dashboardMonthlyAgg}
          monthlyComparisonData={monthlyComparisonData}
          processedMonthlyCumulativeComparison={processedMonthlyCumulativeComparison}
          monthlyCumulativeCosts={monthlyCumulativeCosts}
          dashboardRolling12MonthsData={dashboardRolling12MonthsData}
          formatCurrency={formatCurrency}
          formatCurrencyShortK={formatCurrencyShortK}
          selectedYear={selectedYear}
          month={month}
          setMonth={setMonth}
          currentYear={currentYear}
          COLOR_CHARTREUSE={COLOR_CHARTREUSE}
        />
      )}
      ...
      {view === 'monthly' && (
        <MonthlyView
          ...
          monthlyDonutData={monthlyDonutData}
          monthlyDonutTotal={monthlyDonutTotal}
          processedMonthlyCumulativeComparison={processedMonthlyCumulativeComparison}
          monthlyCumulativeCosts={monthlyCumulativeCosts}
          formatCurrency={formatCurrency}
          selectedYear={selectedYear}
      ...
      {view === 'yearly' && (
        <YearlyView
          ...
          adjustedYearlyYoY={adjustedYearlyYoY}
          formatCurrency={formatCurrency}
          selectedYear={selectedYear}
          currentYear={currentYear}
          yearlyDonutData={yearlyDonutData}
          yearlyTotalTurnover={yearlyTotalTurnover}
          calculatedMonthlyTotals={calculatedMonthlyTotals}
          yearlyData={yearlyData}
          maxYearlyTurnover={maxYearlyTurnover}
          heatmapMaxColor={heatmapMaxColor}
      ...
      {view === 'stock' && (
        <StockView
          ...
          GAUGE_COLORS_RECHARTS={GAUGE_COLORS_RECHARTS}
          GAUGE_MAX_INV_SALES_RATIO={GAUGE_MAX_INV_SALES_RATIO}
          GAUGE_MAX_DSI={GAUGE_MAX_DSI}
          inventoryHistoryData={inventoryHistoryData}
          inventoryTurnoverLoading={inventoryTurnoverLoading}
          inventoryAndTurnoverHistory={inventoryAndTurnoverHistory}
          yearlyDailyStockMovements={yearlyDailyStockMovements}
          getDaysInMonth={getDaysInMonth}
          COLOR_ELECTRIC_PURPLE={COLOR_ELECTRIC_PURPLE}
          CHART_GRID_COLOR={CHART_GRID_COLOR}
          CHART_AXIS_COLOR={CHART_AXIS_COLOR}
          everyThirdMonthTick={everyThirdMonthTick}
        />
      )}
